...
assert.equal(milCtx.CLASSES.inf.glyph, '步'); // 地图徽记保留汉字，不走翻译
...
assert.equal(milCtx.NAVAL.names['de:bb:1'][0].n, 'Bismarck');
assert.equal(milCtx.NAVAL.names['de:sub:0'][0].n, 'U-29');       // 舷号规则去“号”
assert.equal(milCtx.NAVAL.names['su:sub:0'][0].n, 'Shch-301');   // 西里尔舷号转写
