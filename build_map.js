...
const map={...G.spec,rows:rows.map(r=>r.join('')),homes,cityLocations,deployments,rivers,canals,riverEdges:[...riverEdges],blockedEdges:[...new Set(blockedEdges)],routes,landingCells,...labelData,land:[],shallows:[]};
