...
const map={...G.spec,terrainRevision:1,rows:rows.map(r=>r.join('')),homes,cityLocations,deployments,rivers,canals,riverEdges:[...riverEdges],blockedEdges:[...new Set(blockedEdges)],landingCells,...labelData,land:[],shallows:[]};
