...
const R = [
  ...
  { s: [[0,35,'~'],[36,61,'f'],[62,70,'~'],[71,113,'f']] },                                  // 59.5N 斯德哥尔摩(60,14)
  { s: [[0,35,'~'],[36,58,'f'],[59,70,'~'],[71,113,'f']] },                                  // 59N 列宁格勒(85,13)
  // == 英格兰北部 + 丹麦海峡 + 波罗的 (r16-25) ==
  { s: [[0,13,'~'],[14,17,'m'],[18,37,'~'],[38,57,'f'],[58,65,'~'],[66,113,'f']] },          // 58.5N 苏格兰北/挪威南
  { s: [[0,12,'~'],[13,18,'f'],[19,37,'~'],[38,38,'f'],[39,43,'~'],[44,45,'f'],[46,46,'~'],[47,57,'f'],[58,59,'~'],[60,62,'f'],[63,66,'~'],[67,113,'f']], p: [[14,15,'m']] }, // 58N 斯卡格拉克/哥特兰
  { s: [[0,11,'~'],[12,19,'f'],[20,39,'~'],[40,45,'f'],[46,47,'~'],[48,57,'f'],[58,59,'~'],[60,62,'f'],[63,66,'~'],[67,113,'f']] }, // 57.5N 日德兰/卡tg/哥特兰
  ...
  { s: [[0,12,'~'],[13,20,'f'],[21,39,'~'],[40,44,'f'],[45,48,'~'],[49,52,'f'],[53,65,'~'],[66,113,'f']], p: [[14,16,'m']] }, // 56N
  { s: [[0,7,'~'],[8,11,'f'],[12,12,'~'],[13,21,'f'],[22,39,'~'],[40,45,'f'],[46,47,'~'],[48,49,'f'],[50,50,'~'],[51,52,'f'],[53,65,'~'],[66,113,'f']], p: [[9,10,'h']] }, // 55.5N 北爱/大贝尔特/厄勒海峡/哥本哈根(49,22)
  ...
  // == 英格兰 + 低地 + 德国 (r26-33) ==
  { s: [[0,3,'~'],[4,11,'f'],[12,14,'~'],[15,24,'f'],[25,40,'~'],[41,113,'f']], p: [[30,32,'f']] }, // 53.5N 都柏林(11,26) 汉堡(44,26) 斯德丁(53,26)
  ...
  // == 法国 + 德国中部 (r34-41) ==
  { s: [[0,14,'~'],[15,19,'f'],[20,20,'~'],[21,113,'f']], p: [[38,38,'h']] },                // 49.5N 布列塔尼/科唐坦 斯特拉斯堡(39,36)?? (r36)
  { s: [[0,14,'~'],[15,18,'f'],[19,23,'~'],[24,113,'f']], p: [[38,38,'h'],[40,41,'f']] },    // 49N 巴黎(29,35)?? (r35)
  { s: [[0,14,'~'],[15,19,'f'],[20,22,'~'],[23,113,'f']], p: [[38,38,'h'],[40,41,'f'],[50,53,'h']] }, // 48.5N 波希米亚丘陵
  { s: [[0,14,'~'],[15,113,'f']], p: [[38,50,'m'],[70,74,'m']] },                            // 48N 阿尔卑斯北麓/北喀尔巴阡 维也纳(57,37) 慕尼黑(47,37)
  { s: [[0,19,'~'],[20,93,'f'],[94,102,'~'],[103,113,'f']], p: [[38,50,'m'],[69,75,'m']] },  // 47.5N 亚速海
  ...
  { s: [[0,20,'~'],[21,96,'f'],[97,101,'~'],[102,113,'f']], p: [[36,52,'m'],[70,76,'m'],[104,108,'m']] }, // 46N 彼列科普地峡连克里米亚
  // == 波河/巴尔干/克里米亚/高加索 (r42-45) ==
  { s: [[0,21,'~'],[22,47,'f'],[48,52,'~'],[53,81,'f'],[82,90,'~'],[91,97,'f'],[98,100,'~'],[101,113,'f']], p: [[37,38,'m'],[50,52,'m'],[69,75,'m'],[104,110,'m']] }, // 45.5N 都灵(39,43)?? (r43) 米兰(42,42) 里昂(34,42)（利古里亚海收窄防桥接）
  { s: [[0,21,'~'],[22,46,'f'],[47,52,'~'],[53,81,'f'],[82,90,'~'],[91,96,'f'],[97,100,'~'],[101,113,'f']], p: [[69,75,'m'],[104,110,'m']] }, // 45N 克里米亚
  { s: [[0,21,'~'],[22,45,'f'],[46,52,'~'],[53,81,'f'],[82,89,'~'],[90,96,'f'],[97,99,'~'],[100,113,'f']], p: [[37,39,'m'],[43,45,'h'],[69,74,'m'],[104,110,'m']] }, // 44.5N 热那亚湾/塞瓦斯托波尔(91,44)
  { s: [[0,21,'~'],[22,40,'f'],[41,43,'~'],[44,47,'f'],[48,52,'~'],[53,81,'f'],[82,98,'f'],[99,113,'f']], p: [[43,45,'h'],[69,74,'m'],[105,111,'m']] }, // 44N 比斯开湾/托斯卡纳
  // == 伊比利亚 + 意大利 + 巴尔干 + 黑海 (r46-51) ==
  { s: [[0,20,'~'],[21,37,'f'],[38,39,'~'],[40,52,'f'],[53,55,'~'],[56,80,'f'],[81,103,'~'],[104,113,'f']], p: [[21,27,'m'],[40,42,'m'],[48,50,'h'],[56,58,'h'],[105,111,'m']] }, // 43.5N 比利牛斯/马赛(35,46)/迪纳拉
  ...
  { s: [[0,6,'~'],[7,30,'f'],[31,40,'~'],[41,42,'f'],[43,47,'~'],[48,55,'f'],[56,62,'~'],[63,71,'f'],[72,74,'~'],[75,79,'f'],[80,106,'~'],[107,113,'f']], p: [[50,53,'h']] }, // 41.5N 巴塞罗那(28,50) 波尔图(7,51)
  ...
  // == 马其顿/希腊/安纳托利亚 (r52-59) ==
  { s: [[0,6,'~'],[7,24,'f'],[25,41,'~'],[42,43,'f'],[44,52,'f'],[53,60,'f'],[61,62,'~'],[63,70,'f'],[71,75,'~'],[76,83,'f'],[84,85,'~'],[86,113,'f']], p: [[54,56,'m'],[64,66,'m'],[88,100,'h']] }, // 40.5N 马德里(17,52) 萨洛尼卡(70,52) 马尔马拉
  { s: [[0,6,'~'],[7,23,'f'],[24,28,'~'],[29,30,'f'],[31,41,'~'],[42,43,'f'],[44,52,'f'],[53,60,'f'],[61,62,'~'],[63,70,'f'],[71,75,'~'],[76,113,'f']], p: [[55,57,'m'],[64,66,'m'],[88,102,'h']] }, // 40N 帕特雷湾
  { s: [[0,6,'~'],[7,23,'f'],[24,41,'~'],[42,43,'f'],[44,55,'f'],[56,58,'f'],[59,64,'~'],[65,70,'f'],[71,77,'~'],[78,113,'f']], p: [[56,58,'h'],[65,67,'m'],[90,104,'h']] }, // 39.5N 塔兰托/品都斯
  { s: [[0,6,'~'],[7,23,'f'],[24,41,'~'],[42,43,'f'],[44,54,'f'],[55,57,'f'],[58,64,'~'],[65,70,'f'],[71,76,'~'],[77,113,'f']], p: [[55,57,'m'],[66,67,'m'],[90,104,'h']] }, // 39N
  ...
  { s: [[0,6,'~'],[7,20,'f'],[21,48,'~'],[49,54,'f'],[55,55,'~'],[56,58,'f'],[59,66,'~'],[67,69,'f'],[70,77,'~'],[78,113,'f']], p: [[90,104,'h']] }, // 37N 塞维利亚(12,58)
