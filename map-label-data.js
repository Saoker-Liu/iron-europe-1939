...
module.exports=function labelData(G,N){
 ...
 add(1,'region',[
  ...
  ['加利西亚',-7.6,42.8],['巴斯克地区',-2.6,43.1],['加泰罗尼亚',1.5,41.8],['安达卢西亚',-4.5,37.5],
  ['拉普兰',25,67.6],['日德兰',9.2,56.5],['特兰西瓦尼亚',24,46.4],['达尔马提亚',16.7,43.5],
  ['伏尔加河流域',44,54],['安纳托利亚',34.5,39],['波河平原',10.4,45],['伯罗奔尼撒',22,37.5]
 ]);
 add(2,'region',[
 ...
 return {labels,cityLabelLevels,labelZooms:[.24,.65,2.2],labelRevision:1};
};
